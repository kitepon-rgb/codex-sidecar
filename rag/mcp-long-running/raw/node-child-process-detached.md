...
Acquisition: MarkItDown 0.1.5 (non-empty output verified)
-->
...
* [Table of contents](#toc-picker)
  ...
  + [Child process](child_process.html#child-process)
    - [Asynchronous process creation](child_process.html#asynchronous-process-creation)
      * [Spawning `.bat` and `.cmd` files on Windows](child_process.html#spawning-bat-and-cmd-files-on-windows)
      * [`child_process.exec(command[, options][, callback])`](child_process.html#child_processexeccommand-options-callback)
      * [`child_process.execFile(file[, args][, options][, callback])`](child_process.html#child_processexecfilefile-args-options-callback)
      * [`child_process.fork(modulePath[, args][, options])`](child_process.html#child_processforkmodulepath-args-options)
      * [`child_process.spawn(command[, args][, options])`](child_process.html#child_processspawncommand-args-options)
        + [`options.detached`](child_process.html#optionsdetached)
        + [`options.stdio`](child_process.html#optionsstdio)
    - [Synchronous process creation](child_process.html#synchronous-process-creation)
      * [`child_process.execFileSync(file[, args][, options])`](child_process.html#child_processexecfilesyncfile-args-options)
      * [`child_process.execSync(command[, options])`](child_process.html#child_processexecsynccommand-options)
      * [`child_process.spawnSync(command[, args][, options])`](child_process.html#child_processspawnsynccommand-args-options)
    - [Class: `ChildProcess`](child_process.html#class-childprocess)
      * [Event: `'close'`](child_process.html#event-close)
      * [Event: `'disconnect'`](child_process.html#event-disconnect)
      * [Event: `'error'`](child_process.html#event-error)
      * [Event: `'exit'`](child_process.html#event-exit)
      * [Event: `'message'`](child_process.html#event-message)
      * [Event: `'spawn'`](child_process.html#event-spawn)
      * [`subprocess.channel`](child_process.html#subprocesschannel)
        + [`subprocess.channel.ref()`](child_process.html#subprocesschannelref)
        + [`subprocess.channel.unref()`](child_process.html#subprocesschannelunref)
      * [`subprocess.connected`](child_process.html#subprocessconnected)
      * [`subprocess.disconnect()`](child_process.html#subprocessdisconnect)
      * [`subprocess.exitCode`](child_process.html#subprocessexitcode)
      * [`subprocess.kill([signal])`](child_process.html#subprocesskillsignal)
      * [`subprocess[Symbol.dispose]()`](child_process.html#subprocesssymboldispose)
      * [`subprocess.killed`](child_process.html#subprocesskilled)
      * [`subprocess.pid`](child_process.html#subprocesspid)
      * [`subprocess.ref()`](child_process.html#subprocessref)
      * [`subprocess.send(message[, sendHandle[, options]][, callback])`](child_process.html#subprocesssendmessage-sendhandle-options-callback)
        + [Example: sending a server object](child_process.html#example-sending-a-server-object)
        + [Example: sending a socket object](child_process.html#example-sending-a-socket-object)
      * [`subprocess.signalCode`](child_process.html#subprocesssignalcode)
      * [`subprocess.spawnargs`](child_process.html#subprocessspawnargs)
      * [`subprocess.spawnfile`](child_process.html#subprocessspawnfile)
      * [`subprocess.stderr`](child_process.html#subprocessstderr)
      * [`subprocess.stdin`](child_process.html#subprocessstdin)
      * [`subprocess.stdio`](child_process.html#subprocessstdio)
      * [`subprocess.stdout`](child_process.html#subprocessstdout)
      * [`subprocess.unref()`](child_process.html#subprocessunref)
    - [`maxBuffer` and Unicode](child_process.html#maxbuffer-and-unicode)
    - [Shell requirements](child_process.html#shell-requirements)
    - [Default Windows shell](child_process.html#default-windows-shell)
    - [Advanced serialization](child_process.html#advanced-serialization)
* [Index](#gtoc-picker)
...
* [Other versions](#alt-docs)
  ...
  1. [26.x](https://nodejs.org/docs/latest-v26.x/api/child_process.html) * [25.x](https://nodejs.org/docs/latest-v25.x/api/child_process.html) * [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/child_process.html)* [23.x](https://nodejs.org/docs/latest-v23.x/api/child_process.html) * [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/child_process.html)* [21.x](https://nodejs.org/docs/latest-v21.x/api/child_process.html) * [20.x](https://nodejs.org/docs/latest-v20.x/api/child_process.html) * [19.x](https://nodejs.org/docs/latest-v19.x/api/child_process.html) * [18.x](https://nodejs.org/docs/latest-v18.x/api/child_process.html) * [17.x](https://nodejs.org/docs/latest-v17.x/api/child_process.html) * [16.x](https://nodejs.org/docs/latest-v16.x/api/child_process.html) * [15.x](https://nodejs.org/docs/latest-v15.x/api/child_process.html) * [14.x](https://nodejs.org/docs/latest-v14.x/api/child_process.html) * [13.x](https://nodejs.org/docs/latest-v13.x/api/child_process.html) * [12.x](https://nodejs.org/docs/latest-v12.x/api/child_process.html) * [11.x](https://nodejs.org/docs/latest-v11.x/api/child_process.html) * [10.x](https://nodejs.org/docs/latest-v10.x/api/child_process.html) * [9.x](https://nodejs.org/docs/latest-v9.x/api/child_process.html) * [8.x](https://nodejs.org/docs/latest-v8.x/api/child_process.html) * [7.x](https://nodejs.org/docs/latest-v7.x/api/child_process.html) * [6.x](https://nodejs.org/docs/latest-v6.x/api/child_process.html) * [5.x](https://nodejs.org/docs/latest-v5.x/api/child_process.html) * [4.x](https://nodejs.org/docs/latest-v4.x/api/child_process.html) * [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/child_process.html) * [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/child_process.html)
* [Options](#options-picker)

  + [View on single page](all.html)
  + [View as JSON](child_process.json)
...
```
[x] const { spawn } = require('node:child_process');
...
```
[x] const { exec, spawn } = require('node:child_process');
...
|  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Version Changes|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | v16.4.0, v14.18.0 The `cwd` option can be a WHATWG `URL` object using `file:` protocol.| v15.4.0 AbortSignal support was added.|  |  | | --- | --- | | v8.8.0 The `windowsHide` option is supported now. | | | | | | | |
...
```
[x] const { exec } = require('node:child_process');
...
```
[x] const util = require('node:util');
...
|  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Version Changes|  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | | v23.11.0, v22.15.0 Passing `args` when `shell` is set to `true` is deprecated.| v16.4.0, v14.18.0 The `cwd` option can be a WHATWG `URL` object using `file:` protocol.| v15.4.0, v14.17.0 AbortSignal support was added.|  |  | | --- | --- | | v8.8.0 The `windowsHide` option is supported now. | | | | | | | | | |
...
```
[x] const { execFile } = require('node:child_process');
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Version Changes|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | v17.4.0, v16.14.0 The `modulePath` parameter can be a WHATWG `URL` object using `file:` protocol.| v16.4.0, v14.18.0 The `cwd` option can be a WHATWG `URL` object using `file:` protocol.| v15.13.0, v14.18.0 timeout was added.|  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | v15.11.0, v14.18.0 killSignal for AbortSignal was added.|  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | | v15.6.0, v14.17.0 AbortSignal support was added.|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | v13.2.0, v12.16.0 The `serialization` option is supported now.| v8.0.0 The `stdio` option can now be a string.| v6.4.0 The `stdio` option is supported now. | | | | | | | | | | | | | | | | | |
...
```
[x] const { fork } = require('node:child_process');
...
```
[x] const { openSync } = require('node:fs');
...
|  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| Version Changes|  |  |  |  | | --- | --- | --- | --- | | v15.6.0, v14.18.0 Added the `overlapped` stdio flag.| v3.3.1 The value `0` is now accepted as a file descriptor. | | | | | |
...
|  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Version Changes|  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | v16.4.0, v14.18.0 The `cwd` option can be a WHATWG `URL` object using `file:` protocol.| v10.10.0 The `input` option can now be any `TypedArray` or a `DataView`.| v8.8.0 The `windowsHide` option is supported now.| v8.0.0 The `input` option can now be a `Uint8Array`.| v6.2.1, v4.5.0 The `encoding` option can now explicitly be set to `buffer`. | | | | | | | | | | | |
...
```
[x] const { execFileSync } = require('node:child_process');
...
|  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Version Changes|  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | | v16.4.0, v14.18.0 The `cwd` option can be a WHATWG `URL` object using `file:` protocol.| v10.10.0 The `input` option can now be any `TypedArray` or a `DataView`.| v8.8.0 The `windowsHide` option is supported now.| v8.0.0 The `input` option can now be a `Uint8Array`. | | | | | | | | | |
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Version Changes|  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | v16.4.0, v14.18.0 The `cwd` option can be a WHATWG `URL` object using `file:` protocol.| v10.10.0 The `input` option can now be any `TypedArray` or a `DataView`.| v8.8.0 The `windowsHide` option is supported now.| v8.0.0 The `input` option can now be a `Uint8Array`.| v6.2.1, v4.5.0 The `encoding` option can now explicitly be set to `buffer`.| v5.7.0 The `shell` option is supported now. | | | | | | | | | | | | | |
...
|  |  |  |  |
| --- | --- | --- | --- |
| Version Changes|  |  | | --- | --- | | v14.0.0 The object no longer accidentally exposes native C++ bindings. | | | |
...
|  |  |  |  |
| --- | --- | --- | --- |
| Version Changes|  |  | | --- | --- | | v24.2.0 No longer experimental. | | | |
...
|  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Version Changes|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | v5.8.0 The `options` parameter, and the `keepOpen` option in particular, is supported now.| v5.0.0 This method returns a boolean for flow control now.|  |  | | --- | --- | | v4.0.0 The `callback` parameter is supported now. | | | | | | | |
...
```
[x] const assert = require('node:assert');
